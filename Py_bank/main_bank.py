...
print("Average Change: $ ", round_avg_changes)
...
print("Greatest increase in profit:", max_value_date, '(${})'.format(max_value_change))
...
print("Greatest decrease in profit:", min_value_date, ('(${})'.format(min_value_change)))